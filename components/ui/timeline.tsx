    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-gray-900 max-w-4xl font-bold">
          UGO's Environmental Journey
        </h2>
        <p className="text-gray-600 text-sm md:text-base max-w-sm">
          Tracking our progress in global sustainability. Here's a timeline of Universal Greening Organisation's key milestones.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white shadow-md flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-green-500 p-2" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-orange-600 via-orange-400 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
